...
#   account_id   = "vault-gcpkms-700"
#   display_name = "Vault KMS for auto-unseal"
# }

resource "google_compute_instance" "vault" {
  # depends_on = ["google_service_account.vault_kms_service_account"]
  name         = "vault-test"
  ...
  service_account {
    email  = "fuck-494@fuchiclass.iam.gserviceaccount.com"
...
resource "google_kms_key_ring_iam_binding" "vault_iam_kms_binding" {
  ...
  members = [
    "serviceAccount:fuck-494@fuchiclass.iam.gserviceaccount.com",
  ]
}
